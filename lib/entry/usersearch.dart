...
class UserSearchPage extends StatefulWidget {
  static const String id = 'user_search_accounts';
  ...
  void searchAccounts(String query) async {
    ...
    setState(() {
      searchResults = snapshot.docs
          .where((doc) {
            String businessName =
                (doc.data() as Map<String, dynamic>)['business_name'] ?? '';
            print(
                'Business Name: $businessName, Lowercase Query: $lowercaseQuery');
            return businessName.toLowerCase().contains(lowercaseQuery);
          })
